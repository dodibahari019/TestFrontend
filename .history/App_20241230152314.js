      ...
      <ScrollView style={{ marginTop:'8%', borderWidth:1, width:'60%' }}>
        <View style={{ flexDirection:'row', padding:10, justifyContent:'space-between', alignItems:'center', width:'100%' }}>
          ...
          <View style={{ flexDirection:'row', justifyContent:'space-between', alignItems:'center', }}>
            <TextInput style={{ borderWidth:1, paddingHorizontal:30, paddingVertical:6, marginRight:10 }} />
            <TouchableOpacity style={{ backgroundColor:'#ff9a1b', margin paddingHorizontal:20, paddingVertical:8}}>
