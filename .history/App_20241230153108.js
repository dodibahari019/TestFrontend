    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ marginTop:'8%', borderWidth:1, width:'60%' }}>
        ...
        <View style={{ marginTop:5, flexDirection:'row', width:'100%'}}>
          <TouchableOpacity style={{ backgroundColor:'#ff9a1b', borderWidth:0.05, borderColor:'#FFF', width:'15%', paddingHorizontal:20, paddingVertical:8}}>
            <Text style={{ color:'#fff' }}>HOME</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ backgroundColor:'#ff9a1b', borderWidth:0.05, borderColor:'#FFF', width:'24%', paddingHorizontal:20, paddingVertical:8}}>
            <Text style={{ color:'#fff' }}>INK CATEGORI</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ backgroundColor:'#ff9a1b', borderWidth:0.05, borderColor:'#FFF', width:'25%', paddingHorizontal:20, paddingVertical:8}}>
            <Text style={{ color:'#fff' }}>TONER CARTRIDGES</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ backgroundColor:'#ff9a1b', borderWidth:0.05, borderColor:'#FFF', width:'15%', paddingHorizontal:20, paddingVertical:8}}>
            <Text style={{ color:'#fff' }}>CONTACT US</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ backgroundColor:'#ff9a1b', borderWidth:0.05, borderColor:'#FFF', width:'20%', paddingHorizontal:20, paddingVertical:8}}>
