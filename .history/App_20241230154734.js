...
export default function App() {
  return (
    <View style={styles.container}>
      ...
      {/* Body */}
      <ScrollView style={{ marginTop:'4%', borderWidth:1, width:'60%' }}>
        ...
        <View style={{ backgroundColor:'#fff', marginHorizontal:70, marginTop:10, padding:5, height:100 }}>
          <View style={{ flexDirection:'row', justifyContent:'space-between', alignItems:'center', width:'100%' }}>
            <TouchableOpacity style={{ width:'50%', paddingVertical:30, backgroundColor:'#1e88e5', }}>
              <Text style={{ color:'#fff' }}>3-Step Easy Search</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ width:'50%', paddingVertical:30, backgroundColor:'#eeeeee', }}>
              <Text style={{ color:'#fff' }}>3-Step Easy Search</Text>
            </TouchableOpacity>
          </View>
        </View>
