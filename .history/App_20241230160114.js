    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ marginTop:'4%', borderWidth:0, width:'60%' }}>
        ...
        <View style={{ backgroundColor:'#fff', marginHorizontal:70, marginTop:10, padding:5, height:150 }}>
          ...
          <View style={{ marginTop:5, width:'100%', flexDirection:'row', justifyContent:'center', alignItems:'center' }}>
            <View style={{ marginHorizontal:2, width:'20%' }}>
              <Picker
            ...
            <View style={{ marginHorizontal:2, width:'20%', justifyContent:'center' }}>
              <TouchableOpacity style={{ backgroundColor:'#ff9a1b', marginLeft:10, textAlign:'' paddingHorizontal:20, paddingVertical:8}}>
              <Text style={{ color:'#fff' }}>Cart (1)</Text>
            </TouchableOpacity>
            </View>
          </View>
