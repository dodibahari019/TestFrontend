    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ marginTop:'4%', borderWidth:0, width:'60%' }}>
        ...
        <View style={{ backgroundColor:'#fff', marginHorizontal:70, marginTop:10, padding:5, height:150 }}>
          ...
          <View style={{ marginTop:5, paddingHorizontal:5, width:'100%', flexDirection:'row', justifyContent:'center', alignItems:'center' }}>
            ...
            <View style={{ marginHorizontal:2, width:'25%', justifyContent:'center', alignItems:'center' }}>
