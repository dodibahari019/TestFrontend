    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ marginTop:'4%', borderWidth:0, width:'60%' }}>
        ...
        <View style={{ backgroundColor:'#fff', marginHorizontal:70, marginTop:10, padding:5, height:150 }}>
          ...
          <View style={{ marginTop:10, paddingHorizontal:5, width:'100%', flexDirection:'row', justifyContent:'center', alignItems:'center' }}>
            <View style={{ marginHorizontal:2, width:'28%' }}>
              <Picker
            ...
            <View style={{ marginHorizontal:2, justifyContent:'center', alignItems:'center' }}>
              ...
              <Text style={{ color:'#fff' }}>FIND CART</Text>
            </TouchableOpacity>
            </View>
          </View>
        </View>
