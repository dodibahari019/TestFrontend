...
const App = ({}) => {
  ...
  const products = [
    { id: 1, name: 'HP 62 Black Ink Cartridge', price: '$9.49', image: require('./assets/test2.png') },
    { id: 2, name: 'Canon MF-3110 Toner', price: '$36.45', image: require('./assets/test2.png') },
    { id: 3, name: 'HP 62 Black Ink Cartridge', price: '$5.99', image: require('./assets/test2.png') },
  ];
  return (
