...
const App = ({}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Body */}
      <ScrollView style={{ flex:1, marginTop:'4%', borderWidth:0, width:'100%', justifyContent:'center' }}>
        <View style={{ flexDirection:'row', padding:10, justifyContent:'space-between', alignItems:'center', width:'60%' }}>
          <View>
            <Image
