...
const App = ({}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Body */}
      <ScrollView style={{ flex:1, marginTop:'4%', borderWidth:0, width:'100%', }}>
        <View style={{ justifyContent:'center', alignContent:'center', alignItems:'center', textAlign:'center', borderWidth:0 }}>
          <View style={{ flexDirection:'row', padding:10, justifyContent:'space-between', alignContent:'center', alignItems:'center', width:'60%' }}>
          <View>
            <Image
          ...
          {/* Tab */}
          <View style={{ marginTop:5, flexDirection:'row', width:'60%'}}>
        ...
        <ImageBackground
          ...
          style={{ flex:1, width:'100%', resizeMode:'cover', height:250, marginTop:10, padding:5, justifyContent:'center', alignContent:'center', alignItems:'center', textAlign:'center', borderWidth:1}}
        >
        <View style={{ width:'60%', justifyContent:'center', marginTop:10}}>
            <Text style={{ color:'#fff', fontWeight:'bold', textAlign:'center', fontSize:20, }}>FIND THE RIGHT CARTRIDGES FOR YOUR PRINTER</Text>
        </View>
        <View style={{ width:'60%', backgroundColor:'#fff', marginHorizontal:70, marginTop:10, padding:5, height:120 }}>
        ...
        <View style={{ flex: 1, backgroundColor: '#fff', padding: 10, marginVertical:20, justifyContent:'center', alignItems:'center' }}>
          <Text
            style={{
              fontSize: 18,
              fontWeight: 'bold',
