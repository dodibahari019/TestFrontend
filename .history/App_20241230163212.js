    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex:1, marginTop:'4%', borderWidth:0, width:'100%', }}>
        ...
        <ImageBackground
          ...
          style={{ flex:1, width:'100%', resizeMode:'cover', height:250, marginTop:10, padding:5, justifyContent:'center', alignContent:'center', alignItems:'center', textAlign:'center', borderWidth:0}}
        >
